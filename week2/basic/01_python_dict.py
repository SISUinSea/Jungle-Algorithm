...
def find_above_average_students(students):
    ...
    # scores = student.value for student in students
    ...
    over_avg_students = []
    for student in students:
        if student["score"] >= score_avg:
            over_avg_students.append(student)

    return (score_avg, over_avg_students)
